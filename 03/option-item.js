...
var OptionItem = (function () {
    ...
    OptionItem.prototype.onInit = function () {
        this.selected = (this.box.value == this.value);
    };
    OptionItem.prototype.onChange = function (changes) {
        if (changes['selected']) {
            console.log('selected wurde geändert von ' + changes['selected'].previousValue + ' zu ' + changes['selected'].currentValue);
        }
        if (changes['value']) {
            console.log('value wurde geändert von ' + changes['value'].previousValue + ' zu ' + changes['value'].currentValue);
        }
    };
    OptionItem = __decorate([
        angular2_1.Component({
            ...
            events: ['change'],
            lifecycle: [angular2_1.LifecycleEvent.onInit, angular2_1.LifecycleEvent.onChange]
        }),
        angular2_1.View({
